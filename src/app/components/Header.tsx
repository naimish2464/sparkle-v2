...
export function Header() {
  ...
  return (
    <motion.header
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      className={`site-header fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled || mobileMenuOpen
    ...
    >
      <nav className="container mx-auto px-4 sm:px-6 lg:px-12">
        <div className="flex items-center justify-between h-14 sm:h-16 lg:h-20">
          ...
          >
            <img src={logoFile} alt="Sparkle Solitaires" className="site-logo h-10 sm:h-12 lg:h-16 w-auto" />
          </motion.div>
        ...
        {mobileMenuOpen && (
          <motion.div
            ...
            className="lg:hidden pb-6 pt-4 border-t border-gray-200/50 bg-white/95 backdrop-blur-md rounded-b-lg -mx-4 px-4 sm:-mx-6 sm:px-6"
          >
